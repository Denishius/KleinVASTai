...
CHECKPOINT_MODELS=(
    "https://civitai.com/api/download/models/2631758?type=Model&format=SafeTensor&size=pruned&fp=bf16"
...
LORA_MODELS=(
    "https://civitai.com/api/download/models/2771019?type=Model&format=SafeTensor"
)
